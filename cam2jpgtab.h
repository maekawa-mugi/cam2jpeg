...
static uint8_t soi[] = {0xff, 0xd8};
static uint8_t app0[] = {0xff, 0xe0, 0x00, 0x10, 0x4a, 0x46, 0x49, 0x46, 0x00,
                         0x01, 0x01, 0x01, 0x01, 0x2c, 0x01, 0x2c, 0x00, 0x00};

static uint8_t dqt0[] = {0xff, 0xdb, 0x00, 0x43, 0x00};
static uint8_t dqt1[] = {0xff, 0xdb, 0x00, 0x43, 0x01};

static uint8_t sof[] = {0xff, 0xc0, 0x00, 0x11, 0x08, 0x00, 0xf0,
                        0x01, 0xe0, 0x03, 0x01, 0x32, 0x00, 0x02,
...
static uint8_t sos_y[] = {0xff, 0xda, 0x00, 0x08, 0x01,
                          0x01, 0x00, 0x00, 0x3f, 0x00};
static uint8_t sos_u[] = {0xff, 0xda, 0x00, 0x08, 0x01,
                          0x02, 0x11, 0x00, 0x3f, 0x00};
static uint8_t sos_v[] = {0xff, 0xda, 0x00, 0x08, 0x01,
                          0x03, 0x11, 0x00, 0x3f, 0x00};

static uint8_t eoi[] = {0xff, 0xd9};
